...
void ADC::start_conversion_single_channel()
{
    ADC1->ADC_CR2 |= SWSTART;

}

void ADC::start_conversion_continous_single_channel()
{
    ADC1->ADC_CR2 |= CONVERT_CONTINUE; // continous conversion mode enable 
    ADC1->ADC_CR2 |= SWSTART;
}

uint16_t ADC::read_analog()
{
